...
<qgis version="2.12.1-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="BEZIRK"/>
    ...
    <property key="labeling/textColorB" value="102"/>
    <property key="labeling/textColorG" value="102"/>
    <property key="labeling/textColorR" value="102"/>
  ...
  <displayfield>spatial_na</displayfield>
  <label>0</label>
  <labelattributes>
