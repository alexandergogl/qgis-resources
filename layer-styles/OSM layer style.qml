...
<qgis version="2.14.6-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e1888094-383d-4286-946a-54bc79719c02}">
      <rule filter=" &quot;type&quot;  ILIKE  'primary%'" key="{8b0fb20d-af04-4d3a-a44a-6a7f9437012e}" symbol="0" label="primary"/>
      <rule filter=" &quot;type&quot;  ILIKE  'trunk%'" key="{7fd39cd6-401f-487c-aa5c-928ea7acf11c}" symbol="1" label="Trunk"/>
      <rule scalemaxdenom="100000" filter=" &quot;type&quot;  LIKE  'secondary%' " key="{0ecbec1c-45da-444e-9599-96ef5e6b1415}" symbol="2" scalemindenom="1" label="secondary"/>
      <rule scalemaxdenom="100000" filter=" &quot;type&quot; ILIKE  'tertiary%' " key="{a38c18b7-ca53-463d-8455-ae0a74dbbb63}" symbol="3" scalemindenom="1" label="tertiary"/>
      <rule scalemaxdenom="100000" filter=" &quot;type&quot; ILIKE  'residential%' " key="{9d383210-d14b-4423-b083-ffca6c368727}" symbol="4" scalemindenom="1" label="residential"/>
      <rule scalemaxdenom="100000" checkstate="0" filter="ELSE" key="{f212ec91-e65d-4c04-9928-7eaddf6809e4}" symbol="5" scalemindenom="1" label="else"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="2" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="255,251,137,255"/>
          <prop k="line_style" v="solid"/>
